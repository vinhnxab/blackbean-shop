 ...
 *
 * Safe to load when legacy theme inc/schema.php is still present on the server.
 *
...
if ( ! defined( 'BLACKBEAN_SCHEMA_VERSION' ) ) {
	define( 'BLACKBEAN_SCHEMA_VERSION', '2.1.0' );
}

if ( ! defined( 'BLACKBEAN_SCHEMA_VERSION_OPT' ) ) {
	define( 'BLACKBEAN_SCHEMA_VERSION_OPT', 'blackbean_schema_version' );
}

if ( ! function_exists( 'blackbean_table_products' ) ) {
	/**
	 * @return string
	 */
...
if ( ! function_exists( 'blackbean_table_orders' ) ) {
	/**
	 * @return string
	 */
...
if ( ! function_exists( 'blackbean_schema_install' ) ) {
	/**
...
if ( ! has_action( 'init', 'blackbean_schema_install' ) ) {
